...
export default async function Home() {
  ...
  return (
    <div className='from-primary/10 via-surface-2 to-primary/10 mx-auto h-full bg-linear-160 px-6 py-12'>
      {/* Hero Section */}
      ...
      <section className='mt-12'>
        <div className='mb-8'>
          ...
          <p className=''>
            I am still working on more content for the blog, but for now, check
            out my available posts!
          </p>
        </div>
        <div className='grid-col-1 grid gap-6 sm:grid-cols-2 lg:grid-cols-3 2xl:grid-cols-4'>
          {posts.map((post) => (
            <article
              key={post.slug}
