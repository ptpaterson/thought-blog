...
<CalloutNote>
  What I am sharing is what has already been shared publiclyl; for example, in
...
## Separating compute from storage<span class="alt-heading">, or branching and time travel</span>
