...
Fauna certainly isn't perfect, but I can't help but reflect on its unique perspective and what we can learn from it. To that end, I want to take some time to call out things that went well, what perhaps could have been better, and what I want still to see in other DBs.
